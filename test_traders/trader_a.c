...
int main(int argc, char **argv){
    ...
    sleep(1);
    char *msg = "BUY 0 Basil 4 100;", *msg2 = "BUY 1 Chives 1 200;",
    *msg3 = "BUY 2 Coriander 20 200;";
    char *msg4 = "BUY alsdjfhadslkfjhakdsjfhalfkjfshlksdajhflkjdshlfnakjfdhkjhnflakj;";
